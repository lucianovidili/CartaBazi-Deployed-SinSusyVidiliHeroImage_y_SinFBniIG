...
function imgFacebookHandler() {
    //Al clickear en la imagen de Facebook NO SE HACE NADA DADO QUE AHORA ES MI MARCA Y NO TIENE QUE IR AL FB DE MI MAMÁ.

    //window.open("https://www.facebook.com/Biodise%C3%B1o-por-Susy-Vidili-2229887407244837",'_blank');
}

function imgInstagramHandler() {
    //Al clickear en la imagen de Instagram NO SE HACE NADA DADO QUE AHORA ES MI MARCA Y NO TIENE QUE IR AL INSTAGRAM DE MI MAMÁ.
